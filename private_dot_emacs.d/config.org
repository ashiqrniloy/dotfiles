...
#+begin_src emacs-lisp :tangle "early-init.el"
  ...
  (set-face-attribute 'default t :font "MartianMono" :height 106)
...
:PROPERTIES:
:ID:       edcb1780-e85c-4543-9433-8b7d1c4f057d
:CREATED:  [2025-07-09 Wed 18:24]
:END:
...
:END:
:BACKLINKS:
[2025-05-10 Sat 02:44] <- [[id:70fe6549-ddff-4b42-82a9-c11d72409392][Supplementary setup]]
:END:
...
#+begin_src emacs-lisp :tangle "init.el"
  ...
  (custom-theme-set-faces
   'user
   '(fixed-pitch ((t (:family "MartianMono" :height 106))))
   '(variable-pitch ((t (:family "Merriweather" :height 120)))))
...
** Journaling with Org
:PROPERTIES:
:ID:       5fdff83c-2ad5-43a3-93f8-ae6ff88531c8
:CREATED:  [2025-05-09 Fri 18:03]
:END:
...
#+begin_src emacs-lisp :tangle "init.el"
      (use-package org-journal
        :ensure t
        :config
        (setq org-journal-dir "~/Documents/org-files/journal/"))
#+end_src
...
#+begin_src emacs-lisp :tangle "init.el"
  (setq org-preview-latex-process-alist
    '((dvisvg-lua :programs ("lualatex" "dvisvgm")
                  :description "dvi > svg"
                  :message "Install the programs lualatex and dvisvgm"
      ...
      (dvipng-lua :programs ("lualatex" "dvipng")
                  :description "dvi > png"
                  :message "Install the programs lualatex and dvipng"
                  :image-input-type "dvi"
                  ...
                  ("lualatex --interaction=nonstopmode --shell-escape --output-format=dvi --output-directory=%o %f")
                  :image-converter
                  ("dvipng -D %D -bg Transparent -o %O %f")
...
#+begin_src emacs-lisp :tangle "init.el"
    ...
    ;; this needs to be fixed. Does not work yet.
...
#+begin_src emacs-lisp :tangle "init.el"
  ...
  (setq reftex-default-bibliography '("/home/arn/Documents/MSCSE/DL_paper/final_paper/hdqcnn.bib"))
